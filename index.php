...
<head>
    ...
    <style>
        ...
        .content {
            ...
            box-shadow: 0 0 5px rgb(102, 102, 153);
        }
        body{
            background-image: url('data/images/bg4.jpg');
...
<body>
    ...
    <div class="container">
        <div class="tab">
            <button class="tablink active" onclick="openTab(event,'signin')" id="link1" style="background-color:rgb(102, 153, 153);">Login</button>
            <button class="tablink" onclick="openTab(event,'signup')" id="link2" style="background-color:rgb(102, 153, 153)";>Sign Up</button>
        </div>
        <div class="content">
            <div class="tabcontent" id="signin">
                <form method="post" onsubmit="return validateLogin()">
                    ...
                    <div class="required"></div>
                    <br><br>
                    <input type="submit" value="Login" name="login" style="background-color:#85adad;">
                </form>
            </div>
