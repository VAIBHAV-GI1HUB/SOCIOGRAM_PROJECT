...
<head>
    <title><?php 
    $query123 = "SELECT user_firstname, user_lastname from users where user_id = $current_id";
    $ret = mysqli_query($conn, $query123);
    $ret2 = mysqli_fetch_assoc($ret);
...
<body style="background-image:url('data/images/bg3.jpg');background-attachment: fixed;">
    <div class="container">
